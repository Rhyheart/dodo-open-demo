...
### [DoDo.Open.Info-群基础信息获取机器人项目](https://github.com/Rhyheart/dodo-open-demo/tree/main/src/DoDo.Open.Info)

包含：[取群信息](https://open.imdodo.com/api/island/info.html)、[取频道列表](https://open.imdodo.com/api/channel/list.html)、[取身份组列表](https://open.imdodo.com/api/role/list.html)
...
### [DoDo.Open.NftRole-NFT身份组领取机器人项目](https://github.com/Rhyheart/dodo-open-demo/tree/main/src/DoDo.Open.NftRole)

包含：NFT身份组领取规则配置、NFT身份组领取规则触发逻辑、NFT身份组领取规则解析
